...
class Admin_model extends CI_Model {
	...
	function update_profile_image($userid,$profile_image){
    ...
    function get_doctor($user_id = NULL) {
		...
		if ($user_id == NULL) {
            ...
            //$query = $this->db->get_where('view_doctor', array('doctor_id' => $user_id));
    ...
    function change_profile($user_id){
        ...
        $this->session->set_userdata('prefered_language', $data['prefered_language']);
