		...
		<tbody>
			...
			<?php
				...
				if ($bill_details != NULL) {
					...
					foreach ($bill_details as $bill_detail) {
						...
						if ($current_type=='') {
							...
							?>
								...
								<?php }elseif($current_type == "disount" || $current_type == "tax" || $current_type == "Vat Tax"){
					...
					<?php if($current_type != "discount" && $current_type != "tax" && $current_type != "Vat Tax" ){ ?>
				...
				<?php }elseif($current_type == "discount" || $current_type == "tax" || $current_type == "Vat Tax"){ ?>
				...
				<tr class='total'>
					...
					<?=currency_format($total + $session_tax_total + $particular_tax_total + $treatment_tax_total+$lab_test_tax_total+$bill_detail['tax_amount']); ?>
				...
				<?php } ?>
				<?php if($bill_detail['type']=='Vat Tax') { ?>

					<tr>

						<th style="text-align: left;" colspan="2"  >Vat <?php echo $this->lang->line("tax");?></th>
				...
				<tr>
					...
					<th style="text-align: right;"><?=currency_format($total + $session_tax_total + $particular_tax_total + $treatment_tax_total +$lab_test_tax_total - $discount); ?></th>
				...
				<tr>
					...
					<?php $to_be_paid = $total + $tax_total + $session_tax_total + $particular_tax_total + $treatment_tax_total +$lab_test_tax_total -$discount-$paid_amount;?>
