...
class Contact_model extends CI_Model {
	...
	function update_contact_full($contact_id,$first_name,$middle_name,$last_name,$phone_number,$second_number,$display_name,$email,$address_type,$address_line_1,$address_line_2,$city,$state,$area_postal_code,$country,$title=NULL){
	...
	public function ajax_insert_contact($data){
		$this->db->insert('contacts', $data);
		$contact_id = $this->db->insert_id();

		$this->insert_contact_details_full($contact_id,'mobile',$data['phone_number'],1);
		return $contact_id;
