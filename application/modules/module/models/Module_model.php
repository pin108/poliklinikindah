...
class Module_model extends CI_Model {
    ...
    function update_valid_till($v_data) {
      $module_name=$v_data['module_name'];
      $this->db->update('modules', $v_data, array('module_name' => $module_name));
	...
	function deactivate_license($module_name){
