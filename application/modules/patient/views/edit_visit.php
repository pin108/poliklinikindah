...
$(window).load(function(){
	...
	$('.datetimepicker').datetimepicker({
		...
		$( "#add_medicine" ).click(function() {
			...
			medicine += "<div class='col-md-1'><label></label><a href='#' id='delete_medicine"+medicine_count+"' class='btn btn-danger btn-sm square-btn-adjust'><i class='fa fa-trash'></i> Delete</a></div></div></br>";
...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
			<h5 class="m-0 font-weight-bold text-primary"><?php echo $this->lang->line("edit")." ".$this->lang->line("visit");?></h5>
		</div>
					...
					<div class="col-md-12">
						...
						<div id="prescription_list">
							...
							<div class="col-md-12">
								...
								<a id="add_medicine" class="btn btn-primary square-btn-adjust btn-sm"><?=$this->lang->line('add_another_medicine');?></a>
							...
							<?php foreach($prescriptions as $medicine){
								...
								<div class='row'>
									...
									<div class="col-md-1">
										...
										<a href="<?= site_url('prescription/delete_prescription_medicine/'.$visit_id.'/'.$medicine['medicine_id']);?>" class="btn btn-danger btn-sm square-btn-adjust btn-sm" ><i class='fa fa-trash'></i> Delete</a>
				...
				<div class="col-md-12">
					...
					<div class="form-group">
						...
						<?php  if($level != "Nurse"){?>
							...
							<button class="btn btn-primary square-btn-adjust btn-sm" type="submit" name="submit" value="save_complete" /><?php echo $this->lang->line("save_complete");?></button>
						...
						<a class="btn btn-info square-btn-adjust btn-sm" href="<?php echo base_url() . "index.php/patient/visit/" . $patient_id . "/" . $appointment_id; ?>"><?php echo $this->lang->line("back");?></a>
