...
<div class="col-md-12">
	...
	<table width="100%" style='padding:5px;border:1px solid black;'>
		<tr>
			...
			<th>
				<?php if (in_array("prescription", $active_modules) || in_array("treatment", $active_modules)) {?>
						<?php echo $this->lang->line("patient") . ' ' .$this->lang->line("notes");?>
				<?php }?>
			</th>
		</tr>
		<?php
...
?>
															<tr>
																...
																<td width="30%"><?php echo $visit['notes']; ?></td>
																<td width="30%">
																	<?php if (in_array("prescription", $active_modules)) {?>
																		<?php  echo $visit['patient_notes']; ?>
																			<br/><strong><?=$this->lang->line("medicine")?> : </strong>
																			<?php	echo implode(",",$medicine_name[$j-1]);?>
																			<?php	//if((sizeof($medicine_name)>0)&&($j<sizeof($medicine_name))){echo implode(",",$medicine_name[$j]);}?>
																	...
																	<?php if (in_array("treatment", $active_modules)) {
																		...
																		<?php		foreach ($visit_treatments as $visit_treatment) {
																						if($visit_treatment['visit_id']==$visit['visit_id']){
