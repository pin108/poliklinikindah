...
/*	$("#add_medicine_form").validate({
		...
		messages: {
			medicine_name: { required: "<?php echo "Enter Medicine Name.";?>" },
		},
...
//history
$('#history_from_date').datetimepicker({
	timepicker:false,
	format: '<?=$def_dateformate; ?>',
	scrollInput:false,
	scrollMonth:false,
...
$('#history_to_date').datetimepicker({
	timepicker:false,
	format: '<?=$def_dateformate; ?>',
	scrollInput:false,
	scrollMonth:false,
...
?>
	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header expand-collapse-header">
			<h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-arrow-circle-up"></i><?php echo $this->lang->line('patient_details');?><?php echo $this->lang->line('clickto_toggle_display');?></h6>
			</div>
			<div class="card-body expand-collapse-content collapsed">
					...
					<div class="col-md-9">
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<span><strong>(<?=$addresses['type']; ?>)</strong>
					...
					<div class="row" style="margin-left: 10px;">
						<div class="col-md-4">
							<div class="form-group text-align">
								...
								<a class="btn square-btn-adjust btn-primary btn-sm" title="Edit" href="<?php echo site_url("patient/edit/" . $patient['patient_id']."/visit"); ?>"><i class="fa fa-edit"> </i><?php echo $this->lang->line('edit');?></a>
		...
		<div class="card shadow mb-4">
			<div class="card-header expand-collapse-header">
				<h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-arrow-circle-up"></i><?php echo $this->lang->line('new')." ".$this->lang->line('visit'). " " . $this->lang->line('toggle_display');?></h6>
			</div>
			<div class="card-body expand-collapse-content">
						...
						<div class="col-md-12">
									...
									<div class="form-group">
										...
										<?php
											...
											if ($user_level == 'Doctor') {
												...
												<input type="hidden" name="doctor" value="<?=$doctor['doctor_id'];?>"/>
												<input type="hidden" name="departments" id="departments" value="<?=$doctor['department_id'];?>"/><?php
							...
							<div class="col-md-12">
								...
								<div class="col-md-6">
									...
									<a href="#" id="add_related_treatment" class="btn btn-primary square-btn-adjust  btn-sm"><?php echo $this->lang->line('add_related_treatment');?></a>
									...
									<div class="modal-dialog">
										...
										<div class="modal-content">
											...
											<div class="modal-footer">
												...
												<input id="add_treatment_submit" type="submit" name="submit" value="Save" class="btn btn-primary  btn-sm" data-dismiss="modal"/>

												<button type="button" class="btn btn-default  btn-sm" data-dismiss="modal"><?=$this->lang->line('close');?></button>
								...
								$(window).load(function() {
									...
									<?php 
										if ($user_level == 'Doctor') { ?>
											...
											populate_treatment(departments);
									...
									function populate_treatment(departments){
							...
							<script>
										...
										$(window).load(function() {
											...
											$( "#add_medicine" ).click(function() {
												...
												var medicine = "<div class='row'><div class='col-md-2'><label for='medicine' style='display:block;text-align:left;'>Medicine</label><input type='text' name='medicine_name[]' id='medicine_name"+medicine_count+"' class='form-control'/><input type='hidden' name='medicine_id[]' id='medicine_id"+medicine_count+"' class='form-control'/></div>";

												medicine += "<div class='col-md-6'><label for='frequency' style='display:block;text-align:left;'>Frequency</label><div class='row'><div class='col-md-1'>M</div><div class='col-md-3'><input type='text' name='freq_morning[]' id='freq_morning' class='form-control'/></div><div class='col-md-1'>A</div><div class='col-md-3'><input type='text' name='freq_afternoon[]' id='freq_afternoon' class='form-control'/></div><div class='col-md-1'>N</div><div class='col-md-3'><input type='text' name='freq_evening[]' id='freq_evening' class='form-control'/></div></div></div>";

												medicine += "<div class='col-md-1'><label for='days' style='display:block;text-align:left;'>Days</label><input type='text' name='days[]' id='days' class='form-control'/></div>";

												medicine += "<div class='col-md-2'><label for='prescription_notes' style='display:block;text-align:left;'>Instructions</label><input type='text' name='prescription_notes[]' id='prescription_notes' class='form-control'/></div>";

												medicine += "<div class='col-md-1'><label></label><a href='#' id='delete_medicine"+medicine_count+"' class='btn btn-danger btn-sm square-btn-adjust'><i class='fa fa-trash'></i> Delete</a></div></div>";
							...
							<div class="col-md-12">
								...
								<div class="col-md-12">
									...
									<a href="#" id="add_medicine" class="btn btn-primary square-btn-adjust btn-sm"><?php echo $this->lang->line('add_another_medicine');?></a>

									<a id="add_new_medicine" class="btn btn-primary square-btn-adjust btn-sm"  data-toggle="modal" data-target="#myModal">Add Medicine</a>
							...
							<?php if (in_array("marking",$active_modules)) {?>
								...
								<div class="col-md-12">
									...
									<div class="col-md-4">
										...
										<a class="btn btn-primary square-btn-adjust btn-sm" href="<?= site_url('marking/index') ."/". $patient['patient_id'] ."/". $this->input->post('doctor'); ?>"><?php echo $this->lang->line('marking');?></a>
								...
								<div class="col-md-4">
									...
									<div class="form-group text-align">
										...
										<?php  if($level != "Nurse"){?>
											...
											<button class="btn btn-primary square-btn-adjust btn-sm" type="submit" name="save_complete" value="save_complete" /><?php echo $this->lang->line("save_complete");?></button>
		...
		<div class="card shadow mb-4">
			<div class="card-header expand-collapse-header">
				<h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-arrow-circle-up"></i><?php echo $this->lang->line('visit'). " " . $this->lang->line('toggle_display');?></h6>
			</div>
			<div class="card-body expand-collapse-content">
						...
						<div>
							...
							<!--	<a target="_blank" class="btn btn-sm btn-primary square-btn-adjust" href="<?= site_url('patient/print_visit_history') . "/" . $patient_id; ?>"><?php echo $this->lang->line('print').' '.$this->lang->line('history');?></a>-->
							<a id="print_history_btn" class="btn btn-primary square-btn-adjust btn-sm"  data-toggle="modal" data-target="#historyModal"><?php echo $this->lang->line('print').' '.$this->lang->line('history');?></a>
							<a  class="btn btn-primary square-btn-adjust btn-sm" href="<?= site_url('patient/visit_report') . "/" . $patient_id; ?>" ><?php echo $this->lang->line('visit_report');?></a>
								<br/><br/>
							</div>
							<div class="col-md-12 text-align">
									...
									<tr>
										...
										<?php if (in_array("prescription", $active_modules)) { ?>
											...
											<?php if ($this->prescription_model->is_prescription($visit['visit_id'])){ ?>
												...
												<a target="_blank" class="btn  btn-sm btn-primary square-btn-adjust" href="<?= site_url('prescription/print_prescription') . "/" . $visit['visit_id']; ?>"><?php echo $this->lang->line('print') . ' ' . $this->lang->line('prescription');?></a> &nbsp;

												<a class="btn btn-primary  btn-sm square-btn-adjust" href="<?= site_url('prescription/edit_prescription') . "/" . $visit['visit_id']; ?>"><?php echo $this->lang->line('edit') . ' ' . $this->lang->line('prescription');?></a>

											<?php }else{ ?>

												<a target="_blank" class="btn  btn-sm btn-primary square-btn-adjust" href="<?= site_url('prescription/add_prescription') . "/" . $visit['visit_id']; ?>"><?php echo $this->lang->line('add') . ' ' . $this->lang->line('prescription');?></a></br>
											...
											foreach ($visit_lab_tests as $visit_lab_test) {
												...
												if ($visit_lab_test['visit_id'] == $visit['visit_id']) {
													...
													if($visit_lab_test['file_name'] != NULL){
														...
														echo "<a class='btn  btn-sm btn-primary square-btn-adjust' href='".base_url('uploads/reports/'.$visit_lab_test['file_name'])."' target='_blank'>".$lab_test_name[$visit_lab_test['test_id']]."</a>";
										...
										<td><a class="btn btn-primary square-btn-adjust btn-sm" href="<?= site_url('gallery/index') ."/". $visit['patient_id'] ."/". $visit['visit_id']; ?>"><?php echo $this->lang->line('gallery');?></a></td>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<?php $attributes = array('id' => 'add_medicine_form'); ?>
			...
			<div class="modal-body">
					...
					<div class="col-md-12"><input type="text" id="add_medicine_name" name="medicine_name" class="form-control" require/></div>
					<div id="medicine-error" class="alert alert-danger no_margin">Enter Medicine Name.</div>
			</div>

			<div class="modal-footer">

					<input id="add_medicine_submit" type="submit" name="submit" value="Save" class="btn btn-primary btn-sm square-btn-adjust"/>
...
<div class="modal fade" id="historyModal" tabindex="-1" role="dialog" aria-labelledby="historyModal" aria-hidden="true" style="display: none;">

	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('patient').' '.$this->lang->line('history');?></h4>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			</div>
			<?php echo form_open('patient/print_visit_history/'); ?>
			<div class="modal-body">
					<div class="row">
						<input type="hidden" name="patient_id" id="patient_id" value="<?=$patient_id?>" class="form-control"/>
							<div class="col-md-4">
								<div class="form-group">
									<label for="history_from_date"><?=$this->lang->line('from_date');?></label>
									<input type="text" name="history_from_date" id="history_from_date" value="<?php echo $curr_date; ?>" class="form-control"/>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="history_to_date"><?=$this->lang->line('to')." ".$this->lang->line('date');?></label>
									<input type="text" name="history_to_date" id="history_to_date" value="<?php echo $curr_date; ?>" class="form-control"/>
								</div>
							</div>
					</div>
			</div>
			<div class="modal-footer">
					<input type="submit" name="submit" value="Save" class="btn square-btn-adjust btn-primary btn-sm" />
