  ...
  <div class="container-fluid">
	...
	<div class="card shadow mb-4">
			<div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
				<h5 class="m-0 font-weight-bold text-primary"><?php echo $this->lang->line('add')." ".$this->lang->line('language') . " : " .$language_name  ;?></h5>
			</div>
		<div class="card-body">
      <?php
          ...
          <a style="display:none;" id="continue_button" class="btn btn-primary btn-sm square-btn-adjust" href="<?=site_url('settings/upload_new_language_variables_for_language/'.$language_name);?>"><?php echo $this->lang->line('continue'); ?></a>
