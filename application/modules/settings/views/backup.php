...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
			<h5 class="m-0 font-weight-bold text-primary"><?=$this->lang->line("take_backup");?></h5>
		</div>
		<div class="card-body">
			<a class="btn btn-success square-btn-adjust right" href="<?php echo site_url("settings/take_backup/"); ?>"><?php echo $this->lang->line('take_backup');?></a>
			<br/><br/>
		</div>
	</div>
</div>
...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
			<h5 class="m-0 font-weight-bold text-primary"><?php echo $this->lang->line("restore_backup");?></h5>	
		</div>
		<div class="card-body">
			<?php echo form_open_multipart('settings/restore_backup/'); ?>
				...
				<div class="form-group">
					...
					<button class="btn btn-primary btn-sm square-btn-adjust confirmRestore right" type="submit" name="submit" /><?php echo $this->lang->line('restore');?></button>
				...
				<div class="panel-body">
					...
					<?php echo form_open('settings/synchronize/'); ?>
						...
						<div class="form-group">
							...
							<button class="btn btn-primary btn-sm square-btn-adjust right" type="submit" name="submit" />Save</button>
