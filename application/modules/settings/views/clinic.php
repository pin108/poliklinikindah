...
<script type="text/javascript" charset="utf-8">
	...
	if (input.files && input.files[0]) {//Check if input has files.
		...
		$("#PreviewImagefavicon").resizable({ aspectRatio: true, maxHeight: 300 });
...
<?php
...

    {
		...
		$favicon_logo = set_value('favicon_logo','');
...

    {
		...
		$favicon_logo = set_value('favicon_logo',$center['favicon_logo']);
...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
			<h5 class="m-0 font-weight-bold text-primary"><?php echo $this->lang->line('center_detail');?></h5>
		</div>
		<div class="card-body table-responsive-25">
			...
			<div class="row">
				<div class="col-md-8">
					<div class="form-group">
						...
						<?php if($clinic_logo!=""){ ?>
							<img id="PreviewImage" class="PreviewClinicLogo" src="<?php echo base_url().$clinic_logo; ?>" alt="Clinic Logo"   />
						<?php }else{ ?>
							<img id="PreviewImage" class="PreviewClinicLogo"src="<?php echo base_url()."uploads/images/blank_logo.png"; ?>" alt="Clinic Logo"   />
						<?php } ?>
						&nbsp;<a href="<?= site_url("settings/remove_clinic_logo"); ?>" class="btn btn-sm square-btn-adjust btn-danger right" ><?php echo $this->lang->line('remove_logo');?></a>
						<br>
						...
						<span class="right"><?php echo $this->lang->line('preferred_size');?></span>
						<?php if(isset($error)){?>
				...
				<div class="col-md-4">
					<br/><br/><br/><br/><br/>
					<div class="form-group">
						<label for="favicon"><?php echo $this->lang->line('favicon');?></label><br/>
						<?php if($favicon_logo!=""){ ?>
							<img id="PreviewImagefavicon" width="15px" height="15px" class="Previewfavicon" src="<?php echo base_url().$favicon_logo; ?>" alt="Favicon Logo"   />
						<?php }else{ ?>
							<img id="PreviewImagefavicon" class="Previewfavicon"src="<?php echo base_url()."/favicon.ico"; ?>" alt="Favicon Logo"   />
						<?php } ?>

						<input type="file" id="favicon_logo" name="favicon_logo" class="form-control" size="20" onchange="readURLFavicon(this);" style="margin-top:5px;padding-top:5px" />
						<span class="right"><?php echo $this->lang->line('preferred_size_icon');?></span>
						<?php if(isset($icon_error)){?>
							<div class='alert alert-danger'><?=$icon_error;?></div>
						<?php } ?>
						</br>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<small class="right">(<?php echo $this->lang->line('in_minutes');?>)</small>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<span class="time_interval"><?php echo $this->lang->line('numbersof_days_between_two_appointments');?></span>
