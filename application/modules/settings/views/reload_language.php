...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
			<h5 class="m-0 font-weight-bold text-primary"><?php echo $this->lang->line('reload_language_file') . " : " .$language_name  ;?></h5>
    </div>
    <div class="card-body">
      <?php
        ...
        foreach($language_files as $language_file){
          ...
          foreach($language_array as $language_data){

            $existing_keys[]=$language_data['l_index'];
          ...
          foreach($lang as $key => $l){
            ...
            if(in_array($key,$existing_keys)){
              ...
              $sql = "UPDATE ".$dbprefix."language_data SET l_value = '".addslashes($l)."' WHERE l_name='".addslashes($language_name)."' AND l_index='".addslashes($key)."';";
