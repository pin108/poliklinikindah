	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<input type="submit" name="submit" id="submit" class="btn btn-primary btn-sm" value="<?php echo $this->lang->line('add');?>" />
...
<div class="row">
	<div class="col-md-6">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
				<h5 class="m-0 font-weight-bold text-primary"><?php echo $this->lang->line('settings');?></h5>
			</div>
			<div class="card-body table-responsive-15" >
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="form-group" >
							<button type="submit" name="submit" class="btn btn-primary btn-sm square-btn-adjust right" /><?php echo $this->lang->line('save');?></button>
						</div>
					</div>
				</div>
				<?php echo form_close(); ?>
						...
						<div class="">	
							<div class="panel panel-primary">	
								...
								<div class="panel-body">
									<?php echo form_open('settings/save_patient_account'); ?>
										<div class="col-md-6">
											<?php
												if($patient_account == 1){
											...
											?>
												<div class="form-group">
													<div class="checkbox text-align">
																<input type="checkbox" name="patient_account" id="patient_account" value="1" <?=$checked;?>> <?=$this->lang->line('enable_patient_account');?>
													</div>
										...
										<div class="col-md-12">
											<small> <?=$this->lang->line('patient_account_msg');?></small>
										</div>
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
				<h5 class="m-0 font-weight-bold text-primary"><?php echo $this->lang->line('gallery');?></h5>
			</div>
			<div class="panel-body">
					<?php echo form_open('settings/save_gallery_settings'); ?>
				<div class="card-body table-responsive-15" >
					<div class="form-group">
					<label for="allow_file_size"><?php echo $this->lang->line('file_size');?></label>
					<input type="input" name="allow_file_size" value="<?=$allow_file_size; ?>" class="form-control"/>

				</div>
				<div class="form-group">
					<label for="allow_file_type"><?php echo $this->lang->line('file_type');?></label>
					<input type="input" name="allow_file_type" value="<?=$allow_file_type; ?>" class="form-control"/>
					<small> <?=$this->lang->line('file_type_msg');?></small>
				</div>
				<div class="col-md-4">
					<div class="form-group text-align">
							<button type="submit" name="submit" class="btn btn-primary btn-sm square-btn-adjust" /><?php echo $this->lang->line('save');?></button>
	...
	<div class="col-md-6">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
				<h5 class="m-0 font-weight-bold text-primary"><?php echo $this->lang->line('invoice_details');?></h5>
			</div>
			<div class="card-body table-responsive-15">
					<?php echo form_open('settings/save_invoice') ?>
					<div class="card shadow mb-4">
						<div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
							<h7 class="m-0 font-weight-bold text-primary"><?php echo $this->lang->line('invoice_number');?></h7>
						</div>
						<div class="card-body table-responsive-15" >
							<div class="form-group">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
							<h7 class="m-0 font-weight-bold text-primary"><?php echo $this->lang->line('currency');?></h7>
						</div>
						<div class="card-body table-responsive-15" >
							<div class="form-group">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
							<h7 class="m-0 font-weight-bold text-primary"><?php echo $this->lang->line('tax');?></h7>
						</div>
